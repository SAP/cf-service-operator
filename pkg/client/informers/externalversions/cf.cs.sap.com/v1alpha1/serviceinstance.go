	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CfV1alpha1().ServiceInstances(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CfV1alpha1().ServiceInstances(namespace).Watch(context.TODO(), options)
			},
		},
		&cfcssapcomv1alpha1.ServiceInstance{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceInstanceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cfcssapcomv1alpha1.ServiceInstance{}, f.defaultInformer)
}
