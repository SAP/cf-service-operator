...
import (
	...
	"github.com/sap/cf-service-operator/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type CfV1alpha1Interface interface {
...
// NewForConfig creates a new CfV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new CfV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CfV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &CfV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CfV1alpha1Client for the given config and
